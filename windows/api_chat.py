...
KEY_FILE_PATH = r"C:\Users\你的用户名\apikey.txt"            # API Key 文件路径（建议用绝对路径）
...
SYSTEM_PROMPT_FILE = ""   # 例如: r"C:\Users\你的用户名\prompts\assistant.txt"
...
if __name__ == "__main__":
    ...
    print("💡 流式输出中：按 空格 暂停/继续，按 Ctrl+C 或功能键 打断当前生成\n")
    while True:
        try:
